# Quiztopia 3000 Project Context

> Context file for the `personal-portfolio` React project. The filename refers
> to the featured Quiztopia 3000 project; the repository itself is the full
...
The featured project is **Quiztopia 3000**, a technology quiz application with
difficulty selection, multiple-choice questions, and score tracking.
...
`src/pages/Projects.jsx` currently showcases:
...
The project is a portfolio site, not the Quiztopia application itself. Changes
to Quiztopia-specific content normally belong in the `projects` data array in
`src/pages/Projects.jsx`; changes to the portfolio shell belong in `App.jsx`,
`Navbar.jsx`, `Footer.jsx`, or `ContentPage.jsx` as appropriate.
